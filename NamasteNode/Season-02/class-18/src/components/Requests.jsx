      ...
      <div className="flex flex-col items-center my-10">
        ...
        {requests.map((request, key) => {
          ...
          return (
            <div
              key={key}
              className="flex items-center justify-around p-5 my-4 bg-base-300 w-1/2 rounded-2xl"
            >
              ...
              <div className="flex items-center">
                <button
                  className="btn btn-primary w-2/4 mx-2"
                  onClick={() => {
                ...
                <button
                  className="btn btn-secondary w-2/4 mx-2"
                  onClick={() => {
